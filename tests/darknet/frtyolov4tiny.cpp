...
int main() {
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/weights/frtyolov4tiny.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/weights/frtyolov4tiny.names";
